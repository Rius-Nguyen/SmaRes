...
export default function RegisterPage() {
  // Tạo 2 biến trạng thái để quản lý việc ẩn/hiện cho 2 ô mật khẩu riêng biệt
      ...
      <div className="relative z-10 bg-white w-full max-w-md rounded-2xl shadow-2xl p-8 m-4">
        ...
        <form className="space-y-4">
          ...
          <div>
            ...
            <input type="tel" placeholder="0XX XXX XXXX" className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-700 transition-all" />
          </div>
